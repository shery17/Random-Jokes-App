...
const PORT = 8000     // port number to be used for server to listen for requests
...
app.listen(PORT, () => {  // express app starts to listen for requests objects. Also takes PORT and a callback function as parameter
    console.log(`Server running at http://localhost:${PORT}`)    // tells us the server is running and where.
